...
function Signup() {
  return (
    <Box className="h-screen">
      ...
      <Box className="h-[90%]   flex items-center flex-col justify-center ">
              ...
              <Box className="h-[70vh]">
                <Box className=" items-center mt-6 flex flex-col space-y-10 w-[90%] md:w-[50%] mx-auto ">
                  <h1 className="text-center border border-[#feb543]  w-[100%] border-x-0 border-t-0 font-bold text-3xl">
                    Create your account on Yocast
                  </h1>
                  <Box className="w-[100%] flex items-center justify-center ">
                    <img className="w-[70%]" src={wellcomeImage} alt="" />
                  </Box>
                  <Box className="w-[100%]">
                    <p className="text-center font-poopins text-[0.69rem] font-sans text-[1rem] tetx-black  w-[100%]  ">
