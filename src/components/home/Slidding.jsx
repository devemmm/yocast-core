    ...
    <Box className="h-[91%]   text-white   flex  relative z-100">
      ...
      <Box className="bottom-0 w-[70%] mx-auto flex justify-start  absolute">
        <Box className="w-[80%] translate-y-5 flex  space-x-4 mx-auto">
          <button className="rounded-full md:w-[10%] lg:w-[5%]  sm:w-[10%]  bg-[#383A90] w-[20%] md:w-[4%] p-2 font-bold h-[100%]">
            {" "}
            <ArrowBackIcon
              onClick={next}
              sx={{ fontWeight: "bold" }}
          ...
          <button className="rounded-full bg-[#383A90]  lg:w-[5%]  w-[20%]  md:w-[4%] sm:w-[10%] p-2 font-bold h-[100%]">
