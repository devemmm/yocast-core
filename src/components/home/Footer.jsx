...
function Footer() {
  ...
  return (
    <Box className="text-white footer flex items-center h-[100%] w-full pt-[190px] md:pt-[24px] ">
      <Box className=" flex flex-col space-y-8 md:w-[70%]  w-[95%] mx-auto ">
        <Typography
          sx={{ fontWeight: "bold" }}
        ...
        <Box className="w-[80%]  flex items-center justify-center border border-x-0 border-b-0 mx-auto">
          <p className="text-center h-[30%]" variant="p">
            &copy; {year + " All Rights Reserved By "} <a className="hover:underline" href="https://github.com/valens200">valens200</a>{" "}
          </p>
        </Box>
      </Box>
    </Box>
